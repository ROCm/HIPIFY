...
* `LLVM+Clang <http://releases.llvm.org>`_ version is determined at least partially by
  ...
  is the latest stable release `21.1.5 <https://github.com/llvm/llvm-project/releases/tag/llvmorg-21.1.5>`_,
...
.. list-table::
  ...
  * - `12.9.1 <https://developer.nvidia.com/cuda-12-9-1-download-archive>`_:sup:`1`
    - `21.1.0 <https://github.com/llvm/llvm-project/releases/tag/llvmorg-21.1.0>`_,
      ...
      `21.1.5 <https://github.com/llvm/llvm-project/releases/tag/llvmorg-21.1.5>`_:sup:`1`
    - ✅
    - ✅
...
``CMake`` can find the desired version of ``LLVM``. For example, ``-DCMAKE_PREFIX_PATH=D:\LLVM\21.1.5\dist``.
...
.. code:: shell
  ...
  ./hipify-clang square.cu --cuda-path=/usr/local/cuda-12.9 --clang-resource-directory=/usr/llvm/21.1.5/dist/lib/clang/21
