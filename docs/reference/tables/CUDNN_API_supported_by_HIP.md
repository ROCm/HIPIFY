...
|`cudnnConvolutionDescriptor_t`|1.0.0|9.0.0| | |`hipdnnConvolutionDescriptor_t`| | | | | |
...
|`cudnnConvolutionBackwardBias`|1.0.0|9.0.0| | |`hipdnnConvolutionBackwardBias`| | | | | |
|`cudnnConvolutionBackwardData`|1.0.0|9.0.0| | |`hipdnnConvolutionBackwardData`| | | | | |
|`cudnnConvolutionBackwardFilter`|1.0.0|9.0.0| | |`hipdnnConvolutionBackwardFilter`| | | | | |
|`cudnnConvolutionBiasActivationForward`|6.0.0|9.0.0| | | | | | | | |
|`cudnnConvolutionForward`|1.0.0|9.0.0| | |`hipdnnConvolutionForward`| | | | | |
|`cudnnCopyAlgorithmDescriptor`|7.1.3|8.0.2| |9.0.0| | | | | | |
|`cudnnCreate`|1.0.0| | | |`hipdnnCreate`| | | | | |
|`cudnnCreateActivationDescriptor`|4.0.0|9.0.0| | |`hipdnnCreateActivationDescriptor`| | | | | |
...
|`cudnnCreateConvolutionDescriptor`|1.0.0|9.0.0| | |`hipdnnCreateConvolutionDescriptor`| | | | | |
...
|`cudnnCreatePoolingDescriptor`|1.0.0|9.0.0| | |`hipdnnCreatePoolingDescriptor`| | | | | |
...
|`cudnnDestroyActivationDescriptor`|4.0.0|9.0.0| | |`hipdnnDestroyActivationDescriptor`| | | | | |
...
|`cudnnDestroyConvolutionDescriptor`|1.0.0|9.0.0| | |`hipdnnDestroyConvolutionDescriptor`| | | | | |
...
|`cudnnDestroyPoolingDescriptor`|1.0.0|9.0.0| | |`hipdnnDestroyPoolingDescriptor`| | | | | |
...
|`cudnnFindConvolutionForwardAlgorithmEx`|5.0.0|9.0.0| | |`hipdnnFindConvolutionForwardAlgorithmEx`| | | | | |
...
|`cudnnGetConvolution2dForwardOutputDim`|2.0.0|9.0.0| | |`hipdnnGetConvolution2dForwardOutputDim`| | | | | |
...
|`cudnnGetConvolutionBackwardDataWorkspaceSize`|3.0.0|9.0.0| | |`hipdnnGetConvolutionBackwardDataWorkspaceSize`| | | | | |
...
|`cudnnGetConvolutionForwardWorkspaceSize`|2.0.0|9.0.0| | |`hipdnnGetConvolutionForwardWorkspaceSize`| | | | | |
...
|`cudnnGetPooling2dDescriptor`|2.0.0|9.0.0| | |`hipdnnGetPooling2dDescriptor`| | | | | |
|`cudnnGetPooling2dForwardOutputDim`|2.0.0|9.0.0| | |`hipdnnGetPooling2dForwardOutputDim`| | | | | |
|`cudnnGetPoolingNdDescriptor`|2.0.0|9.0.0| | | | | | | | |
|`cudnnGetPoolingNdForwardOutputDim`|2.0.0|9.0.0| | | | | | | | |
...
|`cudnnScaleTensor`|2.0.0|9.0.0| | |`hipdnnScaleTensor`| | | | | |
...
|`cudnnSetConvolutionGroupCount`|7.0.5|9.0.0| | |`hipdnnSetConvolutionGroupCount`| | | | | |
...
|`cudnnSetPooling2dDescriptor`|2.0.0|9.0.0| | |`hipdnnSetPooling2dDescriptor`| | | | | |
|`cudnnSetPoolingNdDescriptor`|2.0.0|9.0.0| | |`hipdnnSetPoolingNdDescriptor`| | | | | |
