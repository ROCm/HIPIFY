<head>
    ...
    <meta name="keywords" content="HIPIFY, HIP, ROCm, CUDA, CUDA2HIP, hipification, hipify-clang, hipify-perl, BLAS, cuBLAS, rocBLAS">
</head>
...
|`cublasLtMatmulPreferenceOpaque_t`|11.0| |13.1| | | | | | | | |
...
|`cublasLtMatrixLayoutOpaque_t`|11.0| |13.1| | | | | | | | |
...
|`cublasSetWorkspace`|11.0| | | | | | | | | | |
|`cublasSetWorkspace_v2`|11.0| | | | | | | | | | |
|`cublasShutdown`| | | | | | | | | | | |
|`cublasXerbla`| | | | | | | | | | | |
...
|`cublasCherkEx`|8.0| | | |`rocblas_herk_ex`|7.10.0| | | | | |
...
|`cublasCsyrkEx`|8.0| | | |`rocblas_syrk_ex`|7.10.0| | | | | |
