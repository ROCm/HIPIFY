<head>
    ...
    <meta name="keywords" content="HIPIFY, HIP, ROCm, CUDA, CUDA2HIP, hipification, hipify-clang, hipify-perl, DNN, cuDNN, MIOpen">
</head>
...
|**CUDA**|**A**|**D**|**C**|**R**|**MIOPEN**|**A**|**D**|**C**|**R**|**U**|**E**|
|:--|:-:|:-:|:-:|:-:|:--|:-:|:-:|:-:|:-:|:-:|:-:|
|`CUDNN_16BIT_INDICES`|6.0.0|9.0.0| | |`MIOPEN_16BIT_INDICES`|3.9.0| | | | | |
|`CUDNN_32BIT_INDICES`|6.0.0|9.0.0| | |`MIOPEN_32BIT_INDICES`|3.9.0| | | | | |
|`CUDNN_64BIT_INDICES`|6.0.0|9.0.0| | |`MIOPEN_64BIT_INDICES`|3.9.0| | | | | |
|`CUDNN_8BIT_INDICES`|6.0.0|9.0.0| | |`MIOPEN_8BIT_INDICES`|3.9.0| | | | | |
|`CUDNN_ACTIVATION_CLIPPED_RELU`|4.0.0|9.0.0| | |`miopenActivationCLIPPEDRELU`|2.1.0| | | | | |
...
|`CUDNN_ATTR_DEVICEPROP_JSON_REPRESENTATION`|9.8.0| | | | | | | | | | |
...
|`CUDNN_ATTR_ENGINE_DISABLE_CLUSTER_COOPERATIVE`|9.17.0| | | | | | | | | | |
...
|`CUDNN_ATTR_KERNEL_CACHE_JSON_REPRESENTATION`|9.10.0| | | | | | | | | | |
...
|`CUDNN_ATTR_OPERATION_BLOCK_SCALE_DEQUANTIZE_NEG_SCALE`|9.13.0| | | | | | | | | | |
...
|`CUDNN_ATTR_OPERATION_CONTRACT_BAND_MATRIX_AXIS`|9.10.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_CONTRACT_BAND_MATRIX_LOWER_BANDWIDTH`|9.10.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_CONTRACT_BAND_MATRIX_PAD_VALUE`|9.10.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_CONTRACT_BAND_MATRIX_UPPER_BANDWIDTH`|9.10.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_CONTRACT_BAND_MATRIX_XDESC`|9.10.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_CONTRACT_BAND_MATRIX_YDESC`|9.10.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_CONTRACT_BAND_MAX_TOKEN_VALUE`|9.10.0| | | | | | | | | | |
...
|`CUDNN_ATTR_OPERATION_DIAGONAL_BAND_MASK_BDESC`|9.20.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_DIAGONAL_BAND_MASK_COMPARISON_MODE`|9.20.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_DIAGONAL_BAND_MASK_CU_SEQ_LEN_KVDESC`|9.24.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_DIAGONAL_BAND_MASK_CU_SEQ_LEN_QDESC`|9.24.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_DIAGONAL_BAND_MASK_LEFT_BOUND_DESC`|9.20.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_DIAGONAL_BAND_MASK_SEQ_LEN_KVDESC`|9.20.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_DIAGONAL_BAND_MASK_SEQ_LEN_QDESC`|9.20.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_DIAGONAL_BAND_MASK_SHIFT_RIGHT_BOUND_DESC`|9.20.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_DIAGONAL_BAND_MASK_XDESC`|9.20.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_DIAGONAL_BAND_MASK_YDESC`|9.20.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_EXPAND_BAND_MATRIX_AXIS`|9.10.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_EXPAND_BAND_MATRIX_KV_TOKEN_OFFSET_DESC`|9.10.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_EXPAND_BAND_MATRIX_LOWER_BANDWIDTH`|9.10.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_EXPAND_BAND_MATRIX_PAD_VALUE`|9.10.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_EXPAND_BAND_MATRIX_SPECULATIVE_MASK_DESC`|9.13.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_EXPAND_BAND_MATRIX_UPPER_BANDWIDTH`|9.10.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_EXPAND_BAND_MATRIX_XDESC`|9.10.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_EXPAND_BAND_MATRIX_YDESC`|9.10.0| | | | | | | | | | |
...
|`CUDNN_ATTR_OPERATION_MOE_GROUPED_MATMUL_OUTPUT_DESC`|9.15.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_MOE_GROUPED_MATMUL_TOKEN_DESC`|9.15.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_MOE_GROUPED_MATMUL_TOKEN_INDEX_DESC`|9.15.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_MOE_GROUPED_MATMUL_TOKEN_KS_DESC`|9.15.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_MOE_GROUPED_MATMUL_TOP_K`|9.15.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_MOE_GROUPED_MATMUL_WEIGHT_DESC`|9.15.0| | | | | | | | | | |
...
|`CUDNN_ATTR_OPERATION_REDUCTION_GROUP_OFFSET_DESC`|9.24.0| | | | | | | | | | |
...
|`CUDNN_ATTR_OPERATION_ROPE_BWD_DXDESC`|9.25.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_ROPE_BWD_DYDESC`|9.25.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_ROPE_BWD_FREQSDESC`|9.25.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_ROPE_BWD_OUTPUT_SCALE`|9.25.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_ROPE_BWD_ROPE_DIM`|9.25.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_ROPE_FWD_FREQSDESC`|9.24.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_ROPE_FWD_OUTPUT_SCALE`|9.24.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_ROPE_FWD_ROPE_DIM`|9.24.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_ROPE_FWD_XDESC`|9.24.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_ROPE_FWD_YDESC`|9.24.0| | | | | | | | | | |
...
|`CUDNN_ATTR_OPERATION_SDPA_FWD_AMAX_ODESC`|9.25.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_SDPA_FWD_AMAX_SDESC`|9.25.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_SDPA_FWD_BLOCK_MASK_DESC`|9.14.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_SDPA_FWD_CU_SEQ_LEN_KVDESC`|9.24.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_SDPA_FWD_CU_SEQ_LEN_QDESC`|9.24.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_SDPA_FWD_DESCALE_KDESC`|9.25.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_SDPA_FWD_DESCALE_QDESC`|9.25.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_SDPA_FWD_DESCALE_SDESC`|9.25.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_SDPA_FWD_DESCALE_VDESC`|9.25.0| | | | | | | | | | |
...
|`CUDNN_ATTR_OPERATION_SDPA_FWD_PAGE_TABLE_VDESC`|9.15.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_SDPA_FWD_QDESC`|9.13.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_SDPA_FWD_SCALEDESC`|9.13.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_SDPA_FWD_SCALE_ODESC`|9.25.0| | | | | | | | | | |
|`CUDNN_ATTR_OPERATION_SDPA_FWD_SCALE_SDESC`|9.25.0| | | | | | | | | | |
...
|`CUDNN_ATTR_TENSOR_RAGGED_OFFSET_MULTIPLIER`|9.24.0| | | | | | | | | | |
...
|`CUDNN_ATTR_VARIANT_PACK_OVERRIDE_SHAPES`|9.18.0| | | | | | | | | | |
|`CUDNN_ATTR_VARIANT_PACK_OVERRIDE_STRIDES`|9.18.0| | | | | | | | | | |
|`CUDNN_ATTR_VARIANT_PACK_OVERRIDE_UNIQUE_IDS`|9.18.0| | | | | | | | | | |
...
|`CUDNN_BACKEND_OPERATION_CONTRACT_BAND_MATRIX_DESCRIPTOR`|9.10.0| | | | | | | | | | |
...
|`CUDNN_BACKEND_OPERATION_DIAGONAL_BAND_MASK_DESCRIPTOR`|9.20.0| | | | | | | | | | |
...
|`CUDNN_BACKEND_OPERATION_ROPE_BWD_DESCRIPTOR`|9.25.0| | | | | | | | | | |
|`CUDNN_BACKEND_OPERATION_ROPE_FWD_DESCRIPTOR`|9.24.0| | | | | | | | | | |
...
|`CUDNN_BEHAVIOR_NOTE_CUBLASLT_DEPENDENCY`|9.15.0| | | | | | | | | | |
...
|`CUDNN_DATA_BYTE_BOOLEAN`|9.25.0| | | | | | | | | | |
...
|`CUDNN_KNOB_TYPE_SWAP_AB`|9.18.0| | | | | | | | | | |
...
|`CUDNN_STATUS_NOT_SUPPORTED_INVALID_DYNAMIC_SHAPE`|9.18.0| | | | | | | | | | |
...
|`CUDNN_TYPE_MOE_GROUPED_MATMUL_MODE`|9.15.0| | | |`MIOPEN_TYPE_RNG_DISTRIBUTION`|6.2.0| | | | | |
...
|`cudnnConvolutionBwdDataAlgo_t`|3.0.0| | | |`miopenConvBwdDataAlgorithm_t`|2.1.0| | | | | |
...
|`cudnnConvolutionDescriptor_t`|1.0.0|9.0.0| | |`miopenConvolutionDescriptor_t`|2.1.0| | | | | |
|`cudnnConvolutionFwdAlgoPerfStruct`|8.2.0| | | |`miopenConvAlgoPerf_t`|2.1.0| | | | | |
|`cudnnConvolutionFwdAlgoPerf_t`|3.0.0|9.0.0| | |`miopenConvAlgoPerf_t`|2.1.0| | | | | |
|`cudnnConvolutionFwdAlgo_t`|2.0.0| | | |`miopenConvFwdAlgorithm_t`|2.1.0| | | | | |
|`cudnnConvolutionFwdPreference_t`|2.0.0|7.6.5| |8.0.1| | | | | | | |
|`cudnnConvolutionMode_t`|1.0.0| | | |`miopenConvolutionMode_t`|2.1.0| | | | | |
|`cudnnConvolutionStruct`|1.0.0| | | | | | | | | | |
|`cudnnDataType_t`|1.0.0| | | |`miopenDataType_t`|2.1.0| | | | | |
|`cudnnDebugStruct`|8.2.0| | | | | | | | | | |
|`cudnnDebug_t`|7.1.3| | | | | | | | | | |
|`cudnnDeterminism_t`|6.0.0| | | | | | | | | | |
|`cudnnDirectionMode_t`|5.0.0| | | |`miopenRNNDirectionMode_t`|2.1.0| | | | | |
|`cudnnDivNormMode_t`|3.0.0| | | | | | | | | | |
|`cudnnDropoutDescriptor_t`|5.0.0| | | |`miopenDropoutDescriptor_t`|2.8.0| | | | | |
...
|`cudnnHandle_t`|1.0.0| | | |`miopenHandle_t`|2.1.0| | | | | |
|`cudnnIndicesType_t`|6.0.0|9.0.0| | |`miopenIndicesType_t`|3.9.0| | | | | |
|`cudnnLRNDescriptor_t`|3.0.0| | | |`miopenLRNDescriptor_t`|2.1.0| | | | | |
...
|`cudnnPoolingDescriptor_t`|1.0.0|9.0.0| | |`miopenPoolingDescriptor_t`|2.1.0| | | | | |
|`cudnnPoolingMode_t`|1.0.0|9.0.0| | |`miopenPoolingMode_t`|2.1.0| | | | | |
|`cudnnPoolingStruct`|1.0.0|9.0.0| | | | | | | | | |
|`cudnnRNNAlgo_t`|6.0.0| | | |`miopenRNNAlgo_t`|2.1.0| | | | | |
|`cudnnRNNBiasMode_t`|7.5.0| | | |`miopenRNNBiasMode_t`|2.1.0| | | | | |
...
|`cudnnReduceTensorOp_t`|6.0.0| | | |`miopenReduceTensorOp_t`|3.9.0| | | | | |
...
|`cudnnSoftmaxMode_t`|1.0.0| | | |`miopenSoftmaxMode_t`|2.6.0| | | | | |
|`cudnnSpatialTransformerDescriptor_t`|5.0.0| | | | | | | | | | |
|`cudnnSpatialTransformerStruct`|5.0.0| | | | | | | | | | |
|`cudnnStatus_t`|1.0.0| | | |`miopenStatus_t`|2.1.0| | | | | |
|`cudnnTensorDescriptor_t`|2.0.0| | | |`miopenTensorDescriptor_t`|2.1.0| | | | | |
|`cudnnTensorFormat_t`|1.0.0| | | |`miopenTensorLayout_t`|5.3.0| | | | | |
...
|**CUDA**|**A**|**D**|**C**|**R**|**MIOPEN**|**A**|**D**|**C**|**R**|**U**|**E**|
|:--|:-:|:-:|:-:|:-:|:--|:-:|:-:|:-:|:-:|:-:|:-:|
|`cudnnActivationBackward`|1.0.0|9.0.0| | |`miopenActivationBackward`|2.1.0| | | | | |
|`cudnnActivationForward`|1.0.0|9.0.0| | |`miopenActivationForward`|2.1.0| | | | | |
...
|`cudnnB2BCausalConv1dBackward`|9.24.0| | | | | | | | | | |
|`cudnnB2BCausalConv1dForward`|9.24.0| | | | | | | | | | |
...
|`cudnnBatchNormalizationForwardTraining`|4.0.0|9.0.0| | |`miopenBatchNormalizationForwardTraining`|2.1.0| | | | | |
...
|`cudnnCausalConv1dNwhBackward`|9.24.0| | | | | | | | | | |
|`cudnnCausalConv1dNwhForward`|9.24.0| | | | | | | | | | |
...
|`cudnnConvolutionBackwardData`|1.0.0|9.0.0| | |`miopenConvolutionBackwardData`|2.1.0| | | | | |
...
|`cudnnConvolutionForward`|1.0.0|9.0.0| | |`miopenConvolutionForward`|2.1.0| | | | | |
|`cudnnCopyAlgorithmDescriptor`|7.1.3|8.0.2| |9.0.0| | | | | | | |
|`cudnnCreate`|1.0.0| | | |`miopenCreate`|2.1.0| | | | | |
|`cudnnCreateActivationDescriptor`|4.0.0|9.0.0| | |`miopenCreateActivationDescriptor`|2.1.0| | | | | |
...
|`cudnnCreateConvolutionDescriptor`|1.0.0|9.0.0| | |`miopenCreateConvolutionDescriptor`|2.1.0| | | | | |
|`cudnnCreateDropoutDescriptor`|5.0.0| | | |`miopenCreateDropoutDescriptor`|2.8.0| | | | | |
...
|`cudnnCreateLRNDescriptor`|3.0.0| | | |`miopenCreateLRNDescriptor`|2.1.0| | | | | |
|`cudnnCreateOpTensorDescriptor`|5.0.0|9.0.0| | | | | | | | | |
|`cudnnCreatePersistentRNNPlan`|6.0.0|8.0.1| |9.0.0| | | | | | | |
|`cudnnCreatePoolingDescriptor`|1.0.0|9.0.0| | |`miopenCreatePoolingDescriptor`|2.1.0| | | | | |
|`cudnnCreateRNNDataDescriptor`|7.2.1| | | | | | | | | | |
|`cudnnCreateRNNDescriptor`|5.0.0| | | |`miopenCreateRNNDescriptor`|2.1.0| | | | | |
|`cudnnCreateReduceTensorDescriptor`|6.0.0|9.0.0| | |`miopenCreateReduceTensorDescriptor`|3.9.0| | | | | |
|`cudnnCreateSeqDataDescriptor`|7.5.0|9.0.0| | | | | | | | | |
|`cudnnCreateSpatialTransformerDescriptor`|5.0.0| | | | | | | | | | |
|`cudnnCreateTensorDescriptor`|2.0.0| | | |`miopenCreateTensorDescriptor`|2.1.0| | | | | |
|`cudnnCreateTensorTransformDescriptor`|7.5.0|9.0.0| | | | | | | | | |
|`cudnnDeriveBNTensorDescriptor`|4.0.0|9.0.0| | |`miopenDeriveBNTensorDescriptor`|2.1.0| | | | | |
|`cudnnDeriveNormTensorDescriptor`|8.0.1|9.0.0| | | | | | | | | |
|`cudnnDestroy`|1.0.0| | | |`miopenDestroy`|2.1.0| | | | | |
|`cudnnDestroyActivationDescriptor`|4.0.0|9.0.0| | |`miopenDestroyActivationDescriptor`|2.1.0| | | | | |
...
|`cudnnDestroyConvolutionDescriptor`|1.0.0|9.0.0| | |`miopenDestroyConvolutionDescriptor`|2.1.0| | | | | |
|`cudnnDestroyDropoutDescriptor`|5.0.0| | | |`miopenDestroyDropoutDescriptor`|2.8.0| | | | | |
...
|`cudnnDestroyLRNDescriptor`|3.0.0| | | |`miopenDestroyLRNDescriptor`|2.1.0| | | | | |
|`cudnnDestroyOpTensorDescriptor`|5.0.0|9.0.0| | | | | | | | | |
|`cudnnDestroyPersistentRNNPlan`|6.0.0|8.0.1| |9.0.0| | | | | | | |
|`cudnnDestroyPoolingDescriptor`|1.0.0|9.0.0| | |`miopenDestroyPoolingDescriptor`|2.1.0| | | | | |
|`cudnnDestroyRNNDataDescriptor`|7.2.1| | | | | | | | | | |
|`cudnnDestroyRNNDescriptor`|5.0.0| | | |`miopenDestroyRNNDescriptor`|2.1.0| | | | | |
|`cudnnDestroyReduceTensorDescriptor`|6.0.0|9.0.0| | |`miopenDestroyReduceTensorDescriptor`|3.9.0| | | | | |
|`cudnnDestroySeqDataDescriptor`|7.5.0|9.0.0| | | | | | | | | |
|`cudnnDestroySpatialTransformerDescriptor`|5.0.0| | | | | | | | | | |
|`cudnnDestroyTensorDescriptor`|2.0.0| | | |`miopenDestroyTensorDescriptor`|2.1.0| | | | | |
...
|`cudnnDropoutGetStatesSize`|5.0.0| | | |`miopenDropoutGetStatesSize`|2.8.0| | | | | |
...
|`cudnnFindConvolutionForwardAlgorithmEx`|5.0.0|9.0.0| | |`miopenFindConvolutionForwardAlgorithm`|2.1.0| | | | | |
...
|`cudnnGetConvolution2dForwardOutputDim`|2.0.0|9.0.0| | |`miopenGetConvolutionForwardOutputDim`|2.1.0| | | | | |
...
|`cudnnGetConvolutionBackwardDataWorkspaceSize`|3.0.0|9.0.0| | |`miopenConvolutionBackwardDataGetWorkSpaceSize`|2.1.0| | | | | |
...
|`cudnnGetConvolutionForwardWorkspaceSize`|2.0.0|9.0.0| | |`miopenConvolutionForwardGetWorkSpaceSize`|2.1.0| | | | | |
...
|`cudnnGetLRNDescriptor`|3.0.0| | | |`miopenGetLRNDescriptor`|2.1.0| | | | | |
...
|`cudnnGetPooling2dDescriptor`|2.0.0|9.0.0| | |`miopenGet2dPoolingDescriptor`|2.1.0| | | | | |
|`cudnnGetPooling2dForwardOutputDim`|2.0.0|9.0.0| | |`miopenGetPoolingForwardOutputDim`|2.1.0| | | | | |
...
|`cudnnGetRNNDescriptor`|7.0.5|7.6.5| |8.0.1|`miopenGetRNNDescriptor_V2`|3.5.0| | | | | |
...
|`cudnnGetRNNParamsSize`|5.0.0|8.0.1| |9.0.0|`miopenGetRNNParamsSize`|2.1.0| | | | | |
|`cudnnGetRNNProjectionLayers`|7.1.3|8.0.1| |9.0.0| | | | | | | |
|`cudnnGetRNNTempSpaceSizes`|8.0.1| | | | | | | | | | |
|`cudnnGetRNNTrainingReserveSize`|5.0.0|8.0.1| |9.0.0|`miopenGetRNNTrainingReserveSize`|2.1.0| | | | | |
|`cudnnGetRNNWeightParams`|8.0.1| | | | | | | | | | |
|`cudnnGetRNNWeightSpaceSize`|8.0.1| | | | | | | | | | |
|`cudnnGetRNNWorkspaceSize`|5.0.0|8.0.1| |9.0.0|`miopenGetRNNWorkspaceSize`|2.1.0| | | | | |
|`cudnnGetReduceTensorDescriptor`|6.0.0|9.0.0| | |`miopenGetReduceTensorDescriptor`|3.9.0| | | | | |
|`cudnnGetReductionIndicesSize`|6.0.0|9.0.0| | |`miopenGetReductionIndicesSize`|3.9.0| | | | | |
|`cudnnGetReductionWorkspaceSize`|6.0.0|9.0.0| | |`miopenGetReductionWorkspaceSize`|3.9.0| | | | | |
|`cudnnGetSeqDataDescriptor`|7.5.0|9.0.0| | | | | | | | | |
|`cudnnGetStream`|1.0.0| | | |`miopenGetStream`|2.1.0| | | | | |
|`cudnnGetTensor4dDescriptor`|1.0.0| | | |`miopenGet4dTensorDescriptor`|2.1.0| | | | | |
...
|`cudnnRNNBackwardData`|5.0.0|8.0.2| |9.0.0|`miopenRNNBackwardData`|2.1.0| | | | | |
|`cudnnRNNBackwardDataEx`|7.2.1|8.0.2| |9.0.0| | | | | | | |
|`cudnnRNNBackwardData_v8`|8.0.2| | | | | | | | | | |
|`cudnnRNNBackwardWeights`|5.0.0|8.0.2| |9.0.0|`miopenRNNBackwardWeights`|2.1.0| | | | | |
|`cudnnRNNBackwardWeightsEx`|7.2.1|8.0.2| |9.0.0| | | | | | | |
|`cudnnRNNBackwardWeights_v8`|8.0.2| | | | | | | | | | |
|`cudnnRNNForward`|8.0.1| | | | | | | | | | |
|`cudnnRNNForwardInference`|5.0.0|8.0.1| |9.0.0|`miopenRNNForwardInference`|2.1.0| | | | | |
...
|`cudnnScaleTensor`|2.0.0|9.0.0| | |`miopenScaleTensor`|2.1.0| | | | | |
...
|`cudnnSetConvolutionGroupCount`|7.0.5|9.0.0| | |`miopenSetConvolutionGroupCount`|2.1.0| | | | | |
...
|`cudnnSetDropoutDescriptor`|5.0.0| | | |`miopenSetDropoutDescriptor`|2.8.0| | | | | |
...
|`cudnnSetLRNDescriptor`|3.0.0| | | |`miopenSetLRNDescriptor`|2.1.0| | | | | |
|`cudnnSetOpTensorDescriptor`|5.0.0|9.0.0| | | | | | | | | |
|`cudnnSetPersistentRNNPlan`|6.0.0|8.0.1| |9.0.0| | | | | | | |
|`cudnnSetPooling2dDescriptor`|2.0.0|9.0.0| | |`miopenSet2dPoolingDescriptor`|2.1.0| | | | | |
|`cudnnSetPoolingNdDescriptor`|2.0.0|9.0.0| | |`miopenSetNdPoolingDescriptor`|3.3.0| | | | | |
...
|`cudnnSetRNNDescriptor_v6`|6.0.0|8.0.1| |9.0.0|`miopenSetRNNDescriptor_V2`|3.5.0| | | | | |
...
|`cudnnSetReduceTensorDescriptor`|6.0.0|9.0.0| | |`miopenSetReduceTensorDescriptor`|3.9.0| | | | | |
|`cudnnSetSeqDataDescriptor`|7.5.0|9.0.0| | | | | | | | | |
|`cudnnSetSpatialTransformerNdDescriptor`|5.0.0| | | | | | | | | | |
|`cudnnSetStream`|1.0.0| | | |`miopenSetStream`|2.1.0| | | | | |
|`cudnnSetTensor`|2.0.0| | | |`miopenSetTensor`|2.1.0| | | | | |
|`cudnnSetTensor4dDescriptor`|1.0.0| | | | | | | | | | |
|`cudnnSetTensor4dDescriptorEx`|1.0.0| | | |`miopenSet4dTensorDescriptorEx`|5.3.0| | | | | |
|`cudnnSetTensorNdDescriptor`|2.0.0| | | | | | | | | | |
|`cudnnSetTensorNdDescriptorEx`|6.0.0| | | | | | | | | | |
|`cudnnSetTensorTransformDescriptor`|7.5.0|9.0.0| | | | | | | | | |
|`cudnnSoftmaxBackward`|1.0.0| | | |`miopenSoftmaxBackward_V2`|2.6.0| | | | | |
|`cudnnSoftmaxForward`|1.0.0| | | |`miopenSoftmaxForward_V2`|2.6.0| | | | | |
