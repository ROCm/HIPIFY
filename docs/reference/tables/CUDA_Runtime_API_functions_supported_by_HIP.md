...
|`cudaSetValidDevices`| | | | |`hipSetValidDevices`|6.2.0| | | | | |
...
|`cudaStreamGetAttribute`|11.0| | | |`hipStreamGetAttribute`|7.1.0| | | | | |
...
|`cudaStreamGetId`|12.0| | | |`hipStreamGetId`|7.1.0| | | | | |
...
|`cudaStreamSetAttribute`|11.0| | | |`hipStreamSetAttribute`|7.1.0| | | | | |
...
|`cudaOccupancyMaxPotentialClusterSize`|11.8| | | |`hipOccupancyMaxPotentialClusterSize`|7.13.0| | | | |7.14.0|
...
|`cudaMemPrefetchBatchAsync`|13.0| | | |`hipMemPrefetchBatchAsync`|7.13.0| | | | |7.14.0|
...
|`cudaMemcpy2DArrayToArray`| | | | |`hipMemcpy2DArrayToArray`|6.2.0| | | | | |
...
|`cudaGraphAddDependencies`|10.0| |13.0| |`hipGraphAddDependencies`|4.5.0| | | |13.0| |
...
|`cudaGraphAddNode`|12.2| |13.0| |`hipGraphAddNode`|6.2.0| | | |13.0| |
...
|`cudaGraphExecNodeSetParams`|12.2| | | |`hipGraphExecNodeSetParams`|6.3.0| | | | | |
...
|`cudaGraphRemoveDependencies`|11.0| |13.0| |`hipGraphRemoveDependencies`|5.0.0| | | |13.0| |
...
|**CUDA**|**A**|**D**|**C**|**R**|**HIP**|**A**|**D**|**C**|**R**|**U**|**E**|
|:--|:-:|:-:|:-:|:-:|:--|:-:|:-:|:-:|:-:|:-:|:-:|
|`cudaGetDriverEntryPoint`|11.3|13.0|12.0| |`hipGetDriverEntryPoint`|7.1.0| | | |11.3 11.4 11.5 11.6 11.7 11.8| |
...
|`CUDART_TWO_TO_126_F`| | | | |`HIP_TWO_TO_126_F`|5.3.0| | | | | |
...
|`cudaClusterSchedulingPolicy`|11.8| | | |`hipClusterSchedulingPolicy`|7.13.0| | | | |7.14.0|
|`cudaClusterSchedulingPolicyDefault`|11.8| | | |`hipClusterSchedulingPolicyDefault`|7.13.0| | | | |7.14.0|
|`cudaClusterSchedulingPolicyLoadBalancing`|11.8| | | |`hipClusterSchedulingPolicyLoadBalancing`|7.13.0| | | | |7.14.0|
|`cudaClusterSchedulingPolicySpread`|11.8| | | |`hipClusterSchedulingPolicySpread`|7.13.0| | | | |7.14.0|
...
|`cudaDriverEntryPointQueryResult`|12.0| | | |`hipDriverEntryPointQueryResult`|7.1.0| | | | | |
|`cudaDriverEntryPointSuccess`|12.0| | | |`hipDriverEntryPointSuccess`|7.1.0| | | | | |
|`cudaDriverEntryPointSymbolNotFound`|12.0| | | |`hipDriverEntryPointSymbolNotFound`|7.1.0| | | | | |
|`cudaDriverEntryPointVersionNotSufficent`|12.0| | | |`hipDriverEntryPointVersionNotSufficent`|7.1.0| | | | | |
...
|`cudaEnableLegacyStream`|11.3| | | |`hipEnableLegacyStream`|7.1.0| | | | | |
|`cudaEnablePerThreadDefaultStream`|11.3| | | |`hipEnablePerThreadDefaultStream`|7.1.0| | | | | |
...
|`cudaErrorInvalidClusterSize`|11.8| | | |`hipErrorInvalidClusterSize`|7.13.0| | | | |7.14.0|
...
|`cudaFlushGPUDirectRDMAWritesOptionHost`|11.3| | | |`hipFlushGPUDirectRDMAWritesOptionHost`|6.1.0| | | | | |
|`cudaFlushGPUDirectRDMAWritesOptionMemOps`|11.3| | | |`hipFlushGPUDirectRDMAWritesOptionMemOps`|6.1.0| | | | | |
|`cudaFlushGPUDirectRDMAWritesOptions`|11.3| | | |`hipFlushGPUDirectRDMAWritesOptions`|6.1.0| | | | | |
...
|`cudaFuncAttributeClusterDimMustBeSet`|11.8| | | |`hipFuncAttributeClusterDimMustBeSet`|7.13.0| | | | |7.14.0|
|`cudaFuncAttributeClusterSchedulingPolicyPreference`|11.8| | | |`hipFuncAttributeClusterSchedulingPolicyPreference`|7.13.0| | | | |7.14.0|
...
|`cudaFuncAttributeNonPortableClusterSizeAllowed`|11.8| | | |`hipFuncAttributeNonPortableClusterSizeAllowed`|7.13.0| | | | |7.14.0|
|`cudaFuncAttributePreferredSharedMemoryCarveout`|9.0| | | |`hipFuncAttributePreferredSharedMemoryCarveout`|3.9.0| | | | | |
|`cudaFuncAttributeRequiredClusterDepth`|11.8| | | |`hipFuncAttributeRequiredClusterDepth`|7.13.0| | | | |7.14.0|
|`cudaFuncAttributeRequiredClusterHeight`|11.8| | | |`hipFuncAttributeRequiredClusterHeight`|7.13.0| | | | |7.14.0|
|`cudaFuncAttributeRequiredClusterWidth`|11.8| | | |`hipFuncAttributeRequiredClusterWidth`|7.13.0| | | | |7.14.0|
...
|`cudaGPUDirectRDMAWritesOrdering`|11.3| | | |`hipGPUDirectRDMAWritesOrdering`|6.1.0| | | | | |
|`cudaGPUDirectRDMAWritesOrderingAllDevices`|11.3| | | |`hipGPUDirectRDMAWritesOrderingAllDevices`|6.1.0| | | | | |
...
|`cudaGraphDependencyType`|12.3| | | |`hipGraphDependencyType`|6.2.0| | | | | |
|`cudaGraphDependencyTypeDefault`|12.3| | | |`hipGraphDependencyTypeDefault`|6.2.0| | | | | |
|`cudaGraphDependencyTypeProgrammatic`|12.3| | | |`hipGraphDependencyTypeProgrammatic`|6.2.0| | | | | |
|`cudaGraphDependencyType_enum`|12.3| | | |`hipGraphDependencyType`|6.2.0| | | | | |
|`cudaGraphDeviceNode_t`|12.4| | | | | | | | | | |
|`cudaGraphEdgeData`|12.3| | | |`hipGraphEdgeData`|6.2.0| | | | | |
|`cudaGraphEdgeData_st`|12.3| | | |`hipGraphEdgeData`|6.2.0| | | | | |
...
|`cudaGraphInstantiateInvalidStructure`|12.0| | | |`hipGraphInstantiateInvalidStructure`|6.2.0| | | | | |
|`cudaGraphInstantiateMultipleDevicesNotSupported`|12.0| | | |`hipGraphInstantiateMultipleDevicesNotSupported`|6.2.0| | | | | |
|`cudaGraphInstantiateNodeOperationNotSupported`|12.0| | | |`hipGraphInstantiateNodeOperationNotSupported`|6.2.0| | | | | |
|`cudaGraphInstantiateParams`|12.0| | | |`hipGraphInstantiateParams`|6.2.0| | | | | |
|`cudaGraphInstantiateParams_st`|12.0| | | |`hipGraphInstantiateParams`|6.2.0| | | | | |
|`cudaGraphInstantiateResult`|12.0| | | |`hipGraphInstantiateResult`|6.2.0| | | | | |
|`cudaGraphInstantiateSuccess`|12.0| | | |`hipGraphInstantiateSuccess`|6.2.0| | | | | |
...
|`cudaGraphKernelNodePortDefault`|12.3| | | |`hipGraphKernelNodePortDefault`|6.2.0| | | | | |
|`cudaGraphKernelNodePortLaunchCompletion`|12.3| | | |`hipGraphKernelNodePortLaunchCompletion`|6.2.0| | | | | |
|`cudaGraphKernelNodePortProgrammatic`|12.3| | | |`hipGraphKernelNodePortProgrammatic`|6.2.0| | | | | |
...
|`cudaGraphNodeParams`|12.2| | | |`hipGraphNodeParams`|6.1.0| | | | | |
...
|`cudaLaunchAttributeClusterDimension`|11.8| | | |`hipLaunchAttributeClusterDimension`|7.13.0| | | | |7.14.0|
|`cudaLaunchAttributeClusterSchedulingPolicyPreference`|11.8| | | |`hipLaunchAttributeClusterSchedulingPolicyPreference`|7.13.0| | | | |7.14.0|
...
|`cudaLaunchAttributeIgnore`|11.8| | | |`hipLaunchAttributeIgnore`|7.13.0| | | | |7.14.0|
...
|`cudaLaunchMemSyncDomain`|12.0| | | |`hipLaunchMemSyncDomain`|7.1.0| | | | | |
|`cudaLaunchMemSyncDomainDefault`|12.0| | | |`hipLaunchMemSyncDomainDefault`|7.1.0| | | | | |
|`cudaLaunchMemSyncDomainMap`|12.0| | | |`hipLaunchMemSyncDomainMap`|7.1.0| | | | | |
...
|`cudaLibrary_t`|12.8| | | |`hipLibrary_t`|7.1.0| | | | | |
...
|`cudaMemFabricHandle_st`|12.3| | | |`hipMemFabricHandle_st`|7.14.0| | | | | |
|`cudaMemFabricHandle_t`|12.3| | | |`hipMemFabricHandle_t`|7.14.0| | | | | |
|`cudaMemFreeNodeParams`|12.2| | | |`hipMemFreeNodeParams`|6.1.0| | | | | |
|`cudaMemHandleTypeFabric`|12.4| | | |`hipMemHandleTypeFabric`|7.14.0| | | | | |
...
|`cudaMemcpy3DBatchOp`|12.8| | | |`hipMemcpy3DBatchOp`|7.1.0| | | | | |
|`cudaMemcpy3DOperand`|12.8| | | |`hipMemcpy3DOperand`|7.1.0| | | | | |
|`cudaMemcpy3DOperandType`|12.8| | | |`hipMemcpy3DOperandType`|7.1.0| | | | | |
|`cudaMemcpy3DParms`| | | | |`hipMemcpy3DParms`|1.7.0| | | | | |
|`cudaMemcpy3DPeerParms`| | | | |`hipMemcpy3DPeerParms`|7.1.0| | | | | |
|`cudaMemcpyAttributes`|12.8| | | |`hipMemcpyAttributes`|7.1.0| | | | | |
...
|`cudaMemcpyFlagDefault`|12.8| | | |`hipMemcpyFlagDefault`|7.1.0| | | | | |
|`cudaMemcpyFlagPreferOverlapWithCompute`|12.8| | | |`hipMemcpyFlagPreferOverlapWithCompute`|7.1.0| | | | | |
|`cudaMemcpyFlags`|12.8| | | |`hipMemcpyFlags`|7.1.0| | | | | |
...
|`cudaMemcpySrcAccessOrder`|12.8| | | |`hipMemcpySrcAccessOrder`|7.1.0| | | | | |
|`cudaMemcpySrcAccessOrderAny`|12.8| | | |`hipMemcpySrcAccessOrderAny`|7.1.0| | | | | |
|`cudaMemcpySrcAccessOrderDuringApiCall`|12.8| | | |`hipMemcpySrcAccessOrderDuringApiCall`|7.1.0| | | | | |
|`cudaMemcpySrcAccessOrderInvalid`|12.8| | | |`hipMemcpySrcAccessOrderInvalid`|7.1.0| | | | | |
|`cudaMemcpySrcAccessOrderMax`|12.8| | | |`hipMemcpySrcAccessOrderMax`|7.1.0| | | | | |
|`cudaMemcpySrcAccessOrderStream`|12.8| | | |`hipMemcpySrcAccessOrderStream`|7.1.0| | | | | |
...
|`cudaOffset3D`|12.8| | | |`hipOffset3D`|7.1.0| | | | | |
|`cudaOutputMode`| | | |12.0| | | | | | | |
...
|`cudaStreamAttributeMemSyncDomain`|12.0| | | |`hipLaunchAttributeMemSyncDomain`|7.1.0| | | | | |
|`cudaStreamAttributeMemSyncDomainMap`|12.0| | | |`hipLaunchAttributeMemSyncDomainMap`|7.1.0| | | | | |
|`cudaStreamAttributePriority`|12.0| | | |`hipLaunchAttributePriority`|6.2.0| | | | | |
|`cudaStreamAttributeSynchronizationPolicy`|11.0| | | |`hipLaunchAttributeSynchronizationPolicy`|7.1.0| | | | | |
...
|`cudaStreamLegacy`|9.0| | | |`hipStreamLegacy`|6.2.0| | | | | |
...
|`cudaSyncPolicyAuto`|11.0| | | |`hipSyncPolicyAuto`|7.1.0| | | | | |
|`cudaSyncPolicyBlockingSync`|11.0| | | |`hipSyncPolicyBlockingSync`|7.1.0| | | | | |
|`cudaSyncPolicySpin`|11.0| | | |`hipSyncPolicySpin`|7.1.0| | | | | |
|`cudaSyncPolicyYield`|11.0| | | |`hipSyncPolicyYield`|7.1.0| | | | | |
|`cudaSynchronizationPolicy`|11.0| | | |`hipSynchronizationPolicy`|7.1.0| | | | | |
...
|`cudaThreadGetCacheConfig`| |10.0| |13.0|`hipDeviceGetCacheConfig`|1.6.0| | | | | |
|`cudaThreadGetLimit`| |10.0| |13.0| | | | | | | |
|`cudaThreadSetCacheConfig`| |10.0| |13.0|`hipDeviceSetCacheConfig`|1.6.0| | | | | |
|`cudaThreadSetLimit`| |10.0| |13.0| | | | | | | |
