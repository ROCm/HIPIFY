...
|`CUTENSOR_COMPUTE_DESC_4X16F`|2.5.0.0| | | | | | | | | | |
|`CUTENSOR_COMPUTE_DESC_64F`|2.0.0.0| | | |`HIPTENSOR_COMPUTE_DESC_64F`|7.0.0| | | | | |
|`CUTENSOR_COMPUTE_DESC_8XINT8`|2.4.0.0| | | | | | | | | | |
...
|`CUTENSOR_OPERATION_DESCRIPTOR_BLOCKSPARSE_REPRODUCIBLE`|2.7.0.0| | | | | | | | | | |
...
|`CUTENSOR_PLAN_PREFERENCE_GPU_ARCH`|2.6.0.0| | | | | | | | | | |
...
|**CUDA**|**A**|**D**|**C**|**R**|**HIP**|**A**|**D**|**C**|**R**|**U**|**E**|
|:--|:-:|:-:|:-:|:-:|:--|:-:|:-:|:-:|:-:|:-:|:-:|
|`cutensorBlockSparseContract`|2.3.0.0| | | | | | | | | | |
...
|`cutensorCreateBlockSparseContraction`|2.3.0.0| | | | | | | | | | |
|`cutensorCreateBlockSparseTensorDescriptor`|2.3.0.0| | | | | | | | | | |
...
|`cutensorDestroyBlockSparseTensorDescriptor`|2.3.0.0| | | | | | | | | | |
...
|`cutensorGetVersion`|1.0.1.0| | | |`hiptensorGetVersion`|7.2.0| | | | | |
...
|`cutensorPlanPreferenceGetAttribute`|2.4.0.0| | | | | | | | | | |
