...
|**CUDA**|**A**|**D**|**C**|**R**|**HIP**|**A**|**D**|**C**|**R**|**E**|
|:--|:-:|:-:|:-:|:-:|:--|:-:|:-:|:-:|:-:|:-:|
|`cutensorContract`|2.0.0.0| | | |`hiptensorContract`|7.0.0| | | |7.0.0|
...
|`cutensorCreateContraction`|2.0.0.0| | | |`hiptensorCreateContraction`|7.0.0| | | |7.0.0|
|`cutensorCreateContractionTrinary`|2.2.0.0| | | | | | | | | |
|`cutensorCreateElementwiseBinary`|2.0.0.0| | | |`hiptensorCreateElementwiseBinary`|7.0.0| | | |7.0.0|
|`cutensorCreateElementwiseTrinary`|2.0.0.0| | | |`hiptensorCreateElementwiseTrinary`|7.0.0| | | |7.0.0|
|`cutensorCreatePermutation`|2.0.0.0| | | |`hiptensorCreatePermutation`|7.0.0| | | |7.0.0|
|`cutensorCreatePlan`|2.0.0.0| | | |`hiptensorCreatePlan`|7.0.0| | | |7.0.0|
|`cutensorCreatePlanPreference`|2.0.0.0| | | |`hiptensorCreatePlanPreference`|7.0.0| | | |7.0.0|
|`cutensorCreateReduction`|2.0.0.0| | | |`hiptensorCreateReduction`|7.0.0| | | |7.0.0|
|`cutensorCreateTensorDescriptor`|2.0.0.0| | | |`hiptensorCreateTensorDescriptor`|7.0.0| | | |7.0.0|
|`cutensorDestroy`|1.7.0.0| |2.0.0.0| |`hiptensorDestroy`|5.7.0| |7.0.0| | |
|`cutensorDestroyOperationDescriptor`|2.0.0.0| | | |`hiptensorDestroyOperationDescriptor`|7.0.0| | | |7.0.0|
|`cutensorDestroyPlan`|2.0.0.0| | | |`hiptensorDestroyPlan`|7.0.0| | | |7.0.0|
|`cutensorDestroyPlanPreference`|2.0.0.0| | | |`hiptensorDestroyPlanPreference`|7.0.0| | | |7.0.0|
|`cutensorDestroyTensorDescriptor`|2.0.0.0| | | |`hiptensorDestroyTensorDescriptor`|7.0.0| | | |7.0.0|
|`cutensorElementwiseBinaryExecute`|2.0.0.0| | | |`hiptensorElementwiseBinaryExecute`|7.0.0| | | |7.0.0|
|`cutensorElementwiseTrinaryExecute`|2.0.0.0| | | |`hiptensorElementwiseTrinaryExecute`|7.0.0| | | |7.0.0|
|`cutensorEstimateWorkspaceSize`|2.0.0.0| | | |`hiptensorEstimateWorkspaceSize`|7.0.0| | | |7.0.0|
...
|`cutensorHandleReadPlanCacheFromFile`|2.0.0.0| | | |`hiptensorHandleReadPlanCacheFromFile`|7.0.0| | | |7.0.0|
|`cutensorHandleResizePlanCache`|2.0.0.0| | | |`hiptensorHandleResizePlanCache`|7.0.0| | | |7.0.0|
|`cutensorHandleWritePlanCacheToFile`|2.0.0.0| | | |`hiptensorHandleWritePlanCacheToFile`|7.0.0| | | |7.0.0|
