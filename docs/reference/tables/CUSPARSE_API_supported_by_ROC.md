<head>
    ...
    <meta name="keywords" content="HIPIFY, HIP, ROCm, CUDA, CUDA2HIP, hipification, hipify-clang, hipify-perl, SPARSE, cuSPARSE, rocSPARSE">
</head>
...
|`CUSPARSE_SPMM_BSR_ALG1`|12.5| | | |`rocsparse_spmm_alg_bsr`|5.3.0| | | | | |
...
|`CUSPARSE_SPMV_BSR_ALG1`|13.0| | | |`rocsparse_spmv_alg_bsr`|5.3.0| | | | | |
