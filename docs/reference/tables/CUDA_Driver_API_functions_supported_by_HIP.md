<head>
    ...
    <meta name="keywords" content="HIPIFY, HIP, ROCm, CUDA, CUDA2HIP, hipification, hipify-clang, hipify-perl, Driver API">
</head>
...
|`CUDA_MEMCPY3D_BATCH_OP`|12.8| | | |`hipMemcpy3DBatchOp`|7.1.0| | | | | |
|`CUDA_MEMCPY3D_BATCH_OP_st`|12.8| | | |`hipMemcpy3DBatchOp`|7.1.0| | | | | |
|`CUDA_MEMCPY3D_BATCH_OP_v1`|12.8| | | |`hipMemcpy3DBatchOp`|7.1.0| | | | | |
|`CUDA_MEMCPY3D_PEER`| | | | | | | | | | | |
...
|`CU_GET_PROC_ADDRESS_DEFAULT`|11.3| | | |`hipEnableDefault`|7.1.0| | | | | |
|`CU_GET_PROC_ADDRESS_LEGACY_STREAM`|11.3| | | |`hipEnableLegacyStream`|7.1.0| | | | | |
|`CU_GET_PROC_ADDRESS_PER_THREAD_DEFAULT_STREAM`|11.3| | | |`hipEnablePerThreadDefaultStream`|7.1.0| | | | | |
...
|`CU_JIT_INPUT_CUBIN`| | | | |`hipJitInputCubin`|6.4.0| | | | | |
|`CU_JIT_INPUT_FATBINARY`| | | | |`hipJitInputFatBinary`|6.4.0| | | | | |
|`CU_JIT_INPUT_LIBRARY`| | | | |`hipJitInputLibrary`|6.4.0| | | | | |
|`CU_JIT_INPUT_NVVM`|11.4|12.0| | |`hipJitInputNvvm`|6.4.0| | | | | |
|`CU_JIT_INPUT_OBJECT`| | | | |`hipJitInputObject`|6.4.0| | | | | |
|`CU_JIT_INPUT_PTX`| | | | |`hipJitInputPtx`|6.4.0| | | | | |
...
|`CU_JIT_NUM_INPUT_TYPES`| | | | |`hipJitNumLegacyInputTypes`|6.4.0| | | | | |
...
|`CU_LAUNCH_MEM_SYNC_DOMAIN_REMOTE`|12.0| | | |`hipLaunchMemSyncDomainRemote`|7.1.0| | | | | |
...
|`CU_MEMCPY_FLAG_DEFAULT`|12.8| | | |`hipMemcpyFlagDefault`|7.1.0| | | | | |
|`CU_MEMCPY_FLAG_PREFER_OVERLAP_WITH_COMPUTE`|12.8| | | |`hipMemcpyFlagPreferOverlapWithCompute`|7.1.0| | | | | |
|`CU_MEMCPY_OPERAND_TYPE_ARRAY`|12.8| | | |`hipMemcpyOperandTypeArray`|7.1.0| | | | | |
|`CU_MEMCPY_OPERAND_TYPE_MAX`|12.8| | | |`hipMemcpyOperandTypeMax`|7.1.0| | | | | |
|`CU_MEMCPY_OPERAND_TYPE_POINTER`|12.8| | | |`hipMemcpyOperandTypePointer`|7.1.0| | | | | |
|`CU_MEMCPY_SRC_ACCESS_ORDER_ANY`|12.8| | | |`hipMemcpySrcAccessOrderAny`|7.1.0| | | | | |
|`CU_MEMCPY_SRC_ACCESS_ORDER_DURING_API_CALL`|12.8| | | |`hipMemcpySrcAccessOrderDuringApiCall`|7.1.0| | | | | |
|`CU_MEMCPY_SRC_ACCESS_ORDER_INVALID`|12.8| | | |`hipMemcpySrcAccessOrderInvalid`|7.1.0| | | | | |
|`CU_MEMCPY_SRC_ACCESS_ORDER_MAX`|12.8| | | |`hipMemcpySrcAccessOrderMax`|7.1.0| | | | | |
|`CU_MEMCPY_SRC_ACCESS_ORDER_STREAM`|12.8| | | |`hipMemcpySrcAccessOrderStream`|7.1.0| | | | | |
...
|`CU_STREAM_ATTRIBUTE_SYNCHRONIZATION_POLICY`|11.0| | | |`hipLaunchAttributeSynchronizationPolicy`|7.1.0| | | | | |
...
|`CU_SYNC_POLICY_SPIN`|11.0| | | |`hipSyncPolicySpin`|7.1.0| | | | | |
|`CU_SYNC_POLICY_YIELD`|11.0| | | |`hipSyncPolicyYield`|7.1.0| | | | | |
...
|`CUdevprop_st`| | | | | | | | | | | |
|`CUdevprop_v1`|11.3| | | | | | | | | | |
|`CUdriverProcAddressQueryResult`|12.0| | | |`hipDriverProcAddressQueryResult`|6.2.0| | | | | |
|`CUdriverProcAddressQueryResult_enum`|12.0| | | |`hipDriverProcAddressQueryResult`|6.2.0| | | | | |
...
|`CUflushGPUDirectRDMAWritesOptions`|11.3| | | |`hipFlushGPUDirectRDMAWritesOptions`|6.1.0| | | | | |
|`CUflushGPUDirectRDMAWritesOptions_enum`|11.3| | | |`hipFlushGPUDirectRDMAWritesOptions`|6.1.0| | | | | |
...
|`CUgraphDependencyType`|12.3| | | |`hipGraphDependencyType`|6.2.0| | | | | |
|`CUgraphDependencyType_enum`|12.3| | | |`hipGraphDependencyType`|6.2.0| | | | | |
|`CUgraphDeviceNode`|12.4| | | | | | | | | | |
|`CUgraphDeviceUpdatableNode_st`|12.4| | | | | | | | | | |
|`CUgraphEdgeData`|12.3| | | |`hipGraphEdgeData`|6.2.0| | | | | |
|`CUgraphEdgeData_st`|12.3| | | |`hipGraphEdgeData`|6.2.0| | | | | |
...
|`CUgraphInstantiateResult`|12.0| | | |`hipGraphInstantiateResult`|6.2.0| | | | | |
|`CUgraphInstantiateResult_enum`|12.0| | | |`hipGraphInstantiateResult`|6.2.0| | | | | |
...
|`CUipcMem_flags`| | | | | | | | | | | |
|`CUipcMem_flags_enum`| | | | | | | | | | | |
|`CUjitInputType`| | | | |`hipJitInputType`|6.4.0| | | | | |
|`CUjitInputType_enum`| | | | |`hipJitInputType`|6.4.0| | | | | |
|`CUjit_cacheMode`| | | | | | | | | | | |
...
|`CUjit_target`| | | | | | | | | | | |
|`CUjit_target_enum`| | | | | | | | | | | |
|`CUkern_st`|12.0| | | |`ihipKernel_t`|7.1.0| | | | | |
|`CUkernel`|12.0| | | |`hipKernel_t`|7.1.0| | | | | |
...
|`CUlaunchAttributeValue`|11.8| |13.2| |`hipLaunchAttributeValue`|6.2.0| |7.1.0, 7.13.0| | | |
|`CUlaunchAttributeValue_union`|11.8| |13.2| |`hipLaunchAttributeValue`|6.2.0| |7.1.0, 7.13.0| | | |
...
|`CUlaunchMemSyncDomain`|12.0| | | |`hipLaunchMemSyncDomain`|7.1.0| | | | | |
|`CUlaunchMemSyncDomainMap`|12.0| | | |`hipLaunchMemSyncDomainMap`|7.1.0| | | | | |
|`CUlaunchMemSyncDomainMap_st`|12.0| | | |`hipLaunchMemSyncDomainMap`|7.1.0| | | | | |
|`CUlaunchMemSyncDomain_enum`|12.0| | | |`hipLaunchMemSyncDomain`|7.1.0| | | | | |
|`CUlib_st`|12.0| | | |`ihipLibrary_t`|7.1.0| | | | | |
|`CUlibrary`|12.0| | | |`hipLibrary_t`|7.1.0| | | | | |
|`CUlibraryHostUniversalFunctionAndDataTable`|12.0| | | | | | | | | | |
|`CUlibraryHostUniversalFunctionAndDataTable_st`|12.0| | | | | | | | | | |
|`CUlibraryOption`|12.0| | | |`hipLibraryOption`|7.1.0| | | | | |
|`CUlibraryOption_enum`|12.0| | | |`hipLibraryOption_e`|7.1.0| | | | | |
...
|`CUmemcpy3DOperand`|12.8| | | |`hipMemcpy3DOperand`|7.1.0| | | | | |
|`CUmemcpy3DOperandType`|12.8| | | |`hipMemcpy3DOperandType`|7.1.0| | | | | |
|`CUmemcpy3DOperandType_enum`|12.8| | | |`hipMemcpy3DOperandType`|7.1.0| | | | | |
|`CUmemcpy3DOperand_st`|12.8| | | |`hipMemcpy3DOperand`|7.1.0| | | | | |
|`CUmemcpy3DOperand_v1`|12.8| | | |`hipMemcpy3DOperand`|7.1.0| | | | | |
|`CUmemcpyAttributes`|12.8| | | |`hipMemcpyAttributes`|7.1.0| | | | | |
|`CUmemcpyAttributes_st`|12.8| | | |`hipMemcpyAttributes`|7.1.0| | | | | |
|`CUmemcpyAttributes_v1`|12.8| | | |`hipMemcpyAttributes`|7.1.0| | | | | |
|`CUmemcpyFlags`|12.8| | | |`hipMemcpyFlags`|7.1.0| | | | | |
|`CUmemcpyFlags_enum`|12.8| | | |`hipMemcpyFlags`|7.1.0| | | | | |
|`CUmemcpySrcAccessOrder`|12.8| | | |`hipMemcpySrcAccessOrder`|7.1.0| | | | | |
|`CUmemcpySrcAccessOrder_enum`|12.8| | | |`hipMemcpySrcAccessOrder`|7.1.0| | | | | |
...
|`CUoffset3D`|12.8| | | |`hipOffset3D`|7.1.0| | | | | |
|`CUoffset3D_st`|12.8| | | |`hipOffset3D`|7.1.0| | | | | |
|`CUoffset3D_v1`|12.8| | | |`hipOffset3D`|7.1.0| | | | | |
...
|`CUstreamAttrValue`|11.0| | | |`hipLaunchAttributeValue`|6.2.0| |7.1.0, 7.13.0| | | |
|`CUstreamAttrValue_union`|11.0| | |11.8|`hipLaunchAttributeValue`|6.2.0| |7.1.0, 7.13.0| | | |
|`CUstreamAttrValue_v1`|11.3| | | |`hipLaunchAttributeValue`|6.2.0| |7.1.0, 7.13.0| | | |
...
|`CUsurfref`| | | | | | | | | | | |
|`CUsurfref_st`| | | | | | | | | | | |
|`CUsynchronizationPolicy`|11.0| | | |`hipSynchronizationPolicy`|7.1.0| | | | | |
|`CUsynchronizationPolicy_enum`|11.0| | | |`hipSynchronizationPolicy`|7.1.0| | | | | |
|`CUtensorMap`|12.0| | | | | | | | | | |
...
|`cuModuleGetFunctionCount`|12.4| | | |`hipModuleGetFunctionCount`|7.1.0| | | | | |
...
|`cuModuleLoadFatBinary`| | | | |`hipModuleLoadFatBinary`|7.1.0| | | | | |
...
|`cuLibraryLoadFromFile`|12.0| | | |`hipLibraryLoadFromFile`|7.1.0| | | | | |
|`cuLibraryUnload`|12.0| | | |`hipLibraryUnload`|7.1.0| | | | | |
...
|`cuMemcpyAtoA_v2`| | | | |`hipMemcpyAtoA`|6.2.0| | | | | |
|`cuMemcpyAtoD`| | | | |`hipMemcpyAtoD`|6.2.0| | | | | |
|`cuMemcpyAtoD_v2`| | | | |`hipMemcpyAtoD`|6.2.0| | | | | |
...
|`cuMemcpyBatchAsync`|12.8| |13.0| |`hipMemcpyBatchAsync`|7.1.0| | | |13.0| |
...
|`cuMemsetD2D16`| | | | |`hipMemsetD2D16`|7.1.0| | | | | |
|`cuMemsetD2D16Async`| | | | |`hipMemsetD2D16Async`|7.1.0| | | | | |
|`cuMemsetD2D16_v2`| | | | |`hipMemsetD2D16`|7.1.0| | | | | |
|`cuMemsetD2D32`| | | | |`hipMemsetD2D32`|7.1.0| | | | | |
|`cuMemsetD2D32Async`| | | | |`hipMemsetD2D32Async`|7.1.0| | | | | |
|`cuMemsetD2D32_v2`| | | | |`hipMemsetD2D32`|7.1.0| | | | | |
|`cuMemsetD2D8`| | | | |`hipMemsetD2D8`|7.1.0| | | | | |
|`cuMemsetD2D8Async`| | | | |`hipMemsetD2D8Async`|7.1.0| | | | | |
|`cuMemsetD2D8_v2`| | | | |`hipMemsetD2D8`|7.1.0| | | | | |
...
|`cuStreamGetId`|12.0| | | |`hipStreamGetId`|7.1.0| | | | | |
...
|`cuStreamSetAttribute`|11.0| | | |`hipStreamSetAttribute`|7.1.0| | | | | |
...
|`cuGraphInstantiateWithParams`|12.0| | | |`hipGraphInstantiateWithParams`|6.2.0| | | | | |
...
|`cuGraphMemcpyNodeGetParams`|10.0| | | |`hipDrvGraphMemcpyNodeGetParams`|6.3.0| | | | | |
|`cuGraphMemcpyNodeSetParams`|10.0| | | |`hipDrvGraphMemcpyNodeSetParams`|6.3.0| | | | | |
...
|**CUDA**|**A**|**D**|**C**|**R**|**HIP**|**A**|**D**|**C**|**R**|**U**|**E**|
|:--|:-:|:-:|:-:|:-:|:--|:-:|:-:|:-:|:-:|:-:|:-:|
|`cuCheckpointProcessCheckpoint`|12.8| | | | | | | | | | |
|`cuCheckpointProcessGetRestoreThreadId`|12.8| | | | | | | | | | |
|`cuCheckpointProcessGetState`|12.8| | | | | | | | | | |
|`cuCheckpointProcessLock`|12.8| | | | | | | | | | |
