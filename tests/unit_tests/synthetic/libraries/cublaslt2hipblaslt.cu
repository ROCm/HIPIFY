...
int main() {
  ...
  // CHECK-NEXT: hipblasLtMatmulDescAttributes_t BLASLT_MATMUL_DESC_BIAS_BATCH_STRIDE = HIPBLASLT_MATMUL_DESC_BIAS_BATCH_STRIDE;
  ...
  cublasLtMatmulDescAttributes_t BLASLT_MATMUL_DESC_BIAS_BATCH_STRIDE = CUBLASLT_MATMUL_DESC_BIAS_BATCH_STRIDE;
  ...
  // CHECK-NEXT: hipblasLtEpilogue_t BLASLT_EPILOGUE_RELU_AUX = HIPBLASLT_EPILOGUE_RELU_AUX;
  // CHECK-NEXT: hipblasLtEpilogue_t BLASLT_EPILOGUE_RELU_AUX_BIAS = HIPBLASLT_EPILOGUE_RELU_AUX_BIAS;
  // CHECK-NEXT: hipblasLtEpilogue_t BLASLT_EPILOGUE_DGELU_BGRAD = HIPBLASLT_EPILOGUE_DGELU_BGRAD;
  // CHECK-NEXT: hipblasLtEpilogue_t BLASLT_EPILOGUE_DRELU_BGRAD = HIPBLASLT_EPILOGUE_DRELU_BGRAD;
  ...
  cublasLtEpilogue_t BLASLT_EPILOGUE_RELU_AUX = CUBLASLT_EPILOGUE_RELU_AUX;
  cublasLtEpilogue_t BLASLT_EPILOGUE_RELU_AUX_BIAS = CUBLASLT_EPILOGUE_RELU_AUX_BIAS;
  cublasLtEpilogue_t BLASLT_EPILOGUE_DGELU_BGRAD = CUBLASLT_EPILOGUE_DGELU_BGRAD;
  cublasLtEpilogue_t BLASLT_EPILOGUE_DRELU_BGRAD = CUBLASLT_EPILOGUE_DRELU_BGRAD;
#endif
...
#if CUDA_VERSION >= 11050 && CUBLAS_VERSION >= 11704
  // CHECK: hipblasLtMatmulDescAttributes_t BLASLT_MATMUL_DESC_SM_COUNT_TARGET = HIPBLASLT_MATMUL_DESC_SM_COUNT_TARGET;
  cublasLtMatmulDescAttributes_t BLASLT_MATMUL_DESC_SM_COUNT_TARGET = CUBLASLT_MATMUL_DESC_SM_COUNT_TARGET;
#endif

#if CUDA_VERSION >= 11060
  // CHECK: hipblasLtEpilogue_t BLASLT_EPILOGUE_DGELU = HIPBLASLT_EPILOGUE_DGELU;
  // CHECK-NEXT: hipblasLtEpilogue_t BLASLT_EPILOGUE_DRELU = HIPBLASLT_EPILOGUE_DRELU;
  cublasLtEpilogue_t BLASLT_EPILOGUE_DGELU = CUBLASLT_EPILOGUE_DGELU;
  cublasLtEpilogue_t BLASLT_EPILOGUE_DRELU = CUBLASLT_EPILOGUE_DRELU;
#endif
  ...
  // CHECK-NEXT: hipblasLtMatmulDescAttributes_t BLASLT_MATMUL_DESC_EPILOGUE_AUX_DATA_TYPE = HIPBLASLT_MATMUL_DESC_EPILOGUE_AUX_DATA_TYPE;
  ...
  cublasLtMatmulDescAttributes_t BLASLT_MATMUL_DESC_EPILOGUE_AUX_DATA_TYPE = CUBLASLT_MATMUL_DESC_EPILOGUE_AUX_DATA_TYPE;
#endif

#if CUDA_VERSION >= 12080
  // CHECK: hipblasLtMatmulDescAttributes_t BLASLT_MATMUL_DESC_A_SCALE_MODE = HIPBLASLT_MATMUL_DESC_A_SCALE_MODE;
  // CHECK-NEXT: hipblasLtMatmulDescAttributes_t BLASLT_MATMUL_DESC_B_SCALE_MODE = HIPBLASLT_MATMUL_DESC_B_SCALE_MODE;
  cublasLtMatmulDescAttributes_t BLASLT_MATMUL_DESC_A_SCALE_MODE = CUBLASLT_MATMUL_DESC_A_SCALE_MODE;
  cublasLtMatmulDescAttributes_t BLASLT_MATMUL_DESC_B_SCALE_MODE = CUBLASLT_MATMUL_DESC_B_SCALE_MODE;

  // CHECK: hipblasLtMatmulMatrixScale_t blasLtMatmulMatrixScale_t;
  // CHECK-NEXT: hipblasLtMatmulMatrixScale_t BLASLT_MATMUL_MATRIX_SCALE_SCALAR_32F = HIPBLASLT_MATMUL_MATRIX_SCALE_SCALAR_32F;
  // CHECK-NEXT: hipblasLtMatmulMatrixScale_t BLASLT_MATMUL_MATRIX_SCALE_VEC16_UE4M3 = HIPBLASLT_MATMUL_MATRIX_SCALE_VEC16_UE4M3;
  // CHECK-NEXT: hipblasLtMatmulMatrixScale_t BLASLT_MATMUL_MATRIX_SCALE_VEC32_UE8M0 = HIPBLASLT_MATMUL_MATRIX_SCALE_VEC32_UE8M0;
  // CHECK-NEXT: hipblasLtMatmulMatrixScale_t BLASLT_MATMUL_MATRIX_SCALE_END = HIPBLASLT_MATMUL_MATRIX_SCALE_END;
  cublasLtMatmulMatrixScale_t blasLtMatmulMatrixScale_t;
  cublasLtMatmulMatrixScale_t BLASLT_MATMUL_MATRIX_SCALE_SCALAR_32F = CUBLASLT_MATMUL_MATRIX_SCALE_SCALAR_32F;
  cublasLtMatmulMatrixScale_t BLASLT_MATMUL_MATRIX_SCALE_VEC16_UE4M3 = CUBLASLT_MATMUL_MATRIX_SCALE_VEC16_UE4M3;
  cublasLtMatmulMatrixScale_t BLASLT_MATMUL_MATRIX_SCALE_VEC32_UE8M0 = CUBLASLT_MATMUL_MATRIX_SCALE_VEC32_UE8M0;
  cublasLtMatmulMatrixScale_t BLASLT_MATMUL_MATRIX_SCALE_END = CUBLASLT_MATMUL_MATRIX_SCALE_END;
#endif

#if CUDA_VERSION >= 12090
  // CHECK: hipblasLtMatmulMatrixScale_t BLASLT_MATMUL_MATRIX_SCALE_OUTER_VEC_32F = HIPBLASLT_MATMUL_MATRIX_SCALE_OUTER_VEC_32F;
  // CHECK-NEXT: hipblasLtMatmulMatrixScale_t BLASLT_MATMUL_MATRIX_SCALE_VEC128_32F = HIPBLASLT_MATMUL_MATRIX_SCALE_VEC128_32F;
  cublasLtMatmulMatrixScale_t BLASLT_MATMUL_MATRIX_SCALE_OUTER_VEC_32F = CUBLASLT_MATMUL_MATRIX_SCALE_OUTER_VEC_32F;
  cublasLtMatmulMatrixScale_t BLASLT_MATMUL_MATRIX_SCALE_VEC128_32F = CUBLASLT_MATMUL_MATRIX_SCALE_VEC128_32F;
#endif
