...
int main() {
  ...
  // CHECK: rocblas_double_complex dcomplex, dComplexbsrSortedValA, dComplexbsrSortedValC;
  ...
  // CHECK: rocblas_float_complex complex, complexbsrValA, complexbsrSortedValC;
