...
int main() {
  ...
  // CHECK-NEXT: rocsparse_mat_descr matDescr_t, matDescr_t_2, matDescr_C;
  ...
  // CHECK: rocblas_double_complex dcomplex, dComplexbsrSortedValC;
  ...
  // CHECK: rocblas_float_complex complex, complexbsrSortedValC;
