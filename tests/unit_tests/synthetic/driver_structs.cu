...
#undef __CUDA_API_VERSION_INTERNAL
  ...
  // CHECK-NEXT: hipArrayMemoryRequirements ARRAY_MEMORY_REQUIREMENTS_st;
  // CHECK-NEXT: hipArrayMemoryRequirements ARRAY_MEMORY_REQUIREMENTS_v1;
  CUDA_ARRAY_MEMORY_REQUIREMENTS ARRAY_MEMORY_REQUIREMENTS;
  CUDA_ARRAY_MEMORY_REQUIREMENTS_st ARRAY_MEMORY_REQUIREMENTS_st;
  CUDA_ARRAY_MEMORY_REQUIREMENTS_v1 ARRAY_MEMORY_REQUIREMENTS_v1;
#endif
