...
int main() {
  ...
  // CHECK: hipDeviceAttribute_t DEVICE_ATTRIBUTE_HANDLE_TYPE_FABRIC_SUPPORTED = hipDeviceAttributeHandleTypeFabricSupported;
  CUdevice_attribute DEVICE_ATTRIBUTE_HANDLE_TYPE_FABRIC_SUPPORTED = CU_DEVICE_ATTRIBUTE_HANDLE_TYPE_FABRIC_SUPPORTED;

  // CHECK: hipMemAllocationHandleType MEM_HANDLE_TYPE_FABRIC = hipMemHandleTypeFabric;
  CUmemAllocationHandleType MEM_HANDLE_TYPE_FABRIC = CU_MEM_HANDLE_TYPE_FABRIC;
#endif
